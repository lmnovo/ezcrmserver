<?php namespace App\Http\Controllers;
	...
	class AdminEazyTasksUsersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Task Type","name"=>"task_type_id","join"=>"task_type,id"];
			...
			$this->form[] = ['label'=>'Task Type','name'=>'task_type_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'task_type,id'];
			$this->form[] = ['label'=>'Assigned To','name'=>'cms_users_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,name'];
