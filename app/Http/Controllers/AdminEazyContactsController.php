<?php namespace App\Http\Controllers;
	...
	class AdminEazyContactsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Other Phone","name"=>"other_phone"];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:eazy_contacts','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'Address','name'=>'address','type'=>'googlemaps','validation'=>'required|min:1|max:255','width'=>'col-sm-10','latitude'=>'latitude','longitude'=>'lomgitude'];
			...
			$this->form[] = ['label'=>'Other Phone','name'=>'other_phone','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Photo','name'=>'photo','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Contact Type','name'=>'contact_type','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
