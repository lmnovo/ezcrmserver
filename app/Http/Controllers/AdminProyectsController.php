<?php namespace App\Http\Controllers;
	...
	class AdminProyectsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:fases","placeholder"=>"Please enter a valid email address"];
			//$this->form[] = ["label"=>"Datetime","name"=>"datetime","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"Fases Type Id","name"=>"fases_type_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"fases_type,name"];
			...
			//$this->form[] = ["label"=>"Orders Id","name"=>"orders_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"orders,id"];
