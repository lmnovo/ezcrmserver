<?php namespace App\Http\Controllers;
	...
	class AdminEazyTaskType1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "eazy_task_type";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>trans('crudbooster.name'),"name"=>"name"];
			//$this->col[] = ["label"=>trans('crudbooster.color'),"name"=>"color"];
			...
			//$this->form[] = ['label'=>trans('crudbooster.color'),'name'=>'color','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>trans('crudbooster.description'),'name'=>'description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
