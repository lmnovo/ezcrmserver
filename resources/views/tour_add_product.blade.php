...
@section('content')
    ...
    <div class='panel panel-default'>
        <div class='panel-heading' style="background-color: #337ab7; color: white;"><strong><i class="fa fa-user"></i> {{ trans('crudbooster.products_catalog') }}</strong></div>
        ...
        <div class="panel-body" style="padding:20px 0px 0px 0px">
            <form class="form-horizontal" method="post" id="form" enctype="multipart/form-data" action="http://18.220.213.59/crm/campaigns/edit-save/2">
                ...
                <video width="100%" height="100%" controls
                    ...
                    <source
                            src="{{asset('tour/add-products.webm')}}"
                            type="video/webm">
