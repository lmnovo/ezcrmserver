            ...
            $('#newNoteModal').on('click','#saveNote',function(){
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        window.location.href = 'http://18.222.4.15/crm/business/edit/'+business_id;
                    }
                });
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <ul class="list-unstyled project_files" style="text-align: right">
                                                                    ...
                                                                    ?>
                                                                    <li>
                                                                        <a title="{{trans('crudbooster.click_to_view')}}" data-lightbox="roadtrip" href="http://18.222.4.15/files/{{$item}}"><i class="fa fa-picture-o"></i><?php print_r($item); ?></a>
                                                                    </li>
                                                                    <?php
                                                                    }
                                                                    else if($item != '')
                                                                    ...
                                                                    ?>
                                                                    <li>
                                                                        <a title="{{trans('crudbooster.click_to_view')}}" href="http://18.222.4.15/files/{{$item}}" target="_blank"><i class="fa fa-file-pdf-o"></i><?php print_r($item); ?></a>
                                                                    </li>
                                                                    <?php
                                                                    }
                                                                    else
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div  class="col-sm-1" style="padding-top: 5px;">
                                                        <a class="btn btn-xs btn-warning btn-delete" title="{{trans('crudbooster.delete')}}" href="javascript:;" onclick="swal({
                                                                ...
                                                                closeOnConfirm: false },
                                                                function(){  location.href='http://18.222.4.15/crm/eazy_notes/delete/{{ $note->id }}' });"><i class="fa fa-trash"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
