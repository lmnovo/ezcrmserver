    ...
    <div class='panel-body'>
        ...
        <div class="row">
            <div class='col-sm-3'>
                ...
                <input type='text' id="name" name='name' required class='form-control' value="{{ $lead->name }}"/>
            </div>

            <div class='col-sm-3'>
                <label>{{trans('crudbooster.lastname')}}*</label>
                <input type='text' id="lastname" name='lastname' required class='form-control' value="{{ $lead->lastname }}"/>
            </div>

            <div class='col-sm-3'>
                <label>{{trans('crudbooster.email')}}*</label>
                <input type='text' id="email" name='email' required class='form-control' value="{{ $lead->email }}"/>
            </div>

            <div class='col-sm-3'>
                <label>{{trans('crudbooster.phone')}}*</label>
                <input type='text' id="phone" name='phone' required class='form-control' value="{{ $lead->phone }}"/>
            </div>
        </div>
        ...
        <div class="row" style="padding-top: 10px;">
            <div class='col-sm-3'>
                ...
                <input type='text' id="city" name='city' class='form-control' value="{{ $lead->city }}"/>
            </div>
