                ...
                <div class="container-fluid">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" title="{{trans('crudbooster.quantity')}}" required class="form-control number" name="product_quantity" id="product_quantity" value="1">
                                <div class="text-danger"></div>
                                <p class="help-block"></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 col-sm-3 control-label">{{trans('crudbooster.total')}}*</label>
                            <div class="col-md-9">
                                <input type="text" readonly="readonly" title="{{trans('crudbooster.total')}}" required class="form-control number" name="product_total" id="product_total" value="">
                                <div class="text-danger"></div>
                                <p class="help-block"></p>
                            </div>
                        </div>
