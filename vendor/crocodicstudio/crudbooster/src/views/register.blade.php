  ...
  <body class="login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <p class='login-box-msg'>{{trans("crudbooster.register_message")}}</p>
        <form autocomplete='off' action="{{ route('postRegister') }}" method="post">
          ...
          <div class="form-group has-feedback">
            <input autocomplete='off'  type="text" class="form-control" name='password' required placeholder="Password"/>
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div style="margin-bottom:10px" class='row'>
            <div class='col-xs-12'>
                <button type="submit" class="btn btn-primary btn-block btn-flat"><i class='fa fa-lock'></i> {{trans("crudbooster.button_register")}}</button>
            </div>
          </div>
