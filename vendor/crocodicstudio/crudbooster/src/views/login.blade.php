    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
          ...
          <div class='row'>
            <div class='col-xs-12' align="center"><p style="padding:10px 0px 0px 0px"><input type="checkbox" style="padding-top: 20px;"> Remember password <a href='{{route("getForgot")}}'></a>   </p></div>
          </div>
          
          <div class='row'>
            <div class='col-xs-12' align="center"><p style="padding:0px 0px 0px 0px">{{trans("crudbooster.text_forgot_password")}} <a href='{{route("getForgot")}}'>{{trans("crudbooster.click_here")}}</a>   </p></div>
          </div>
        </form>
