...
class PrivilegesController extends CBController {
	...
	public function cbInit() {
		...
		$this->col[] = array("label"=>trans('crudbooster.superadmin'),"name"=>"is_superadmin",'callback_php'=>'($row->is_superadmin)?"<span class=\"label label-success\">Superadmin</span>":"<span class=\"label label-default\">Standard</span>"');

		$this->form   = array();
		$this->form[] = array("label"=>trans('crudbooster.name'),"name"=>"name",'required'=>true);
		$this->form[] = array("label"=>trans('crudbooster.is_superadmin'),"name"=>"is_superadmin",'required'=>true);
		$this->form[] = array("label"=>trans('crudbooster.theme_color'),"name"=>"theme_color",'required'=>true);
	}
