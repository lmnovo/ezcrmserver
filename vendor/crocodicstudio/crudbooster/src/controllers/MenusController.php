...
use CRUDBooster;
	...
	class MenusController extends CBController {
	    ...
	    public function cbInit() {
			...
			$this->form   = array();
			$this->form[] = array("label"=>trans('crudbooster.name'),"name"=>"name","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255|alpha_spaces","placeholder"=>"You can only enter the letter");
			$this->form[] = array("label"=>trans('crudbooster.type'),"name"=>"type","type"=>"radio","required"=>TRUE,'dataenum'=>['Module','Statistic (Statistic Generator)','URL','Controller & Method','Route'],'value'=>'Module');

			$this->form[] = array("label"=>trans('crudbooster.module'),"name"=>"module_slug","type"=>"select","datatable"=>"cms_moduls,name","datatable_where"=>"is_protected = 0","value"=>$id_module);
			$this->form[] = array("label"=>trans('crudbooster.statistic'),"name"=>"statistic_slug","type"=>"select","datatable"=>"cms_statistics,name","style"=>"display:none","value"=>$id_statistic);

			$this->form[] = array("label"=>trans('crudbooster.value'),"name"=>"path","type"=>"text",'help'=>trans('crudbooster.message_menu_management'),'placeholder'=>'NameController or NameController@methodName',"style"=>"display:none");
			...
			$this->form[] = ['label'=>trans('crudbooster.icon'),'name'=>'icon','type'=>'custom','html'=>$custom,'required'=>true];
			...
			$this->form[] = array("label"=>trans('crudbooster.active'),"name"=>"is_active","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>array('1|Active','0|InActive'),'value'=>'1');
			$this->form[] = array("label"=>trans('crudbooster.dashboard'),"name"=>"is_dashboard","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>array('1|Yes','0|No'),'value'=>'0');
