...
class LogsController extends CBController {
	...
	public function cbInit() {		
		...
		$this->col = array();
		$this->col[] = array("label"=>trans('crudbooster.time_access'),"name"=>"created_at");
		$this->col[] = array("label"=>trans('crudbooster.ip_address'),"name"=>"ipaddress");
		$this->col[] = array("label"=>trans('crudbooster.user'),"name"=>"id_cms_users","join"=>"cms_users,name");
		$this->col[] = array("label"=>trans('crudbooster.description'),"name"=>"description");
